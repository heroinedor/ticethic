...
<form name="config_module" method="post" action="admin.php?op=Extend-Admin-SubModule&ModPath=adhesions&ModStart=admin/admin_adhesion&choix=Configuration">
  <table width="100%" border="0" cellspacing="5" cellpadding="2" align="center" b>
    <tr CLASS="HEADER">
      <th colspan="2"> Configuration du module adhésion</th>
    </tr>
    <tr>
      <td class="ONGL" colspan="2" align="center"><strong>Page de l'adhérent</strong></td>
	</tr>
    <tr>
		<TD colspan="2" align="center">
		<BR>
		Texte d'accueil du formulaire d'adhésion :
	  <?
	...
	<tr>
		<td class="ONGL" align="center" colspan="2">
			<strong>Paramètre de l'adhésion</strong>
		</td>
	</tr>
	<tr>
		<td align="center">
			Sélection des groupes adhérants à l'association:&nbsp;<br><br>
			<TABLE border="0">
				<tr>
					<TD>
					<?
						for($i=0; $i<sizeof($groupe);$i++){
							$selected = "";
							foreach ($config_module as $parametre => $valeur){
								if ((substr($parametre,0,10)=='cfg_groupe') && ($valeur==$groupe[$i]['groupe_id'])){
									$selected = "checked";
								}
							}
							echo '<INPUT type="checkbox" name=\'cfg_groupe[]\' value="'.$groupe[$i]['groupe_id'].'" '.$selected.'>'.$groupe[$i]['groupe_name']."<br>\n";
						}
					?>
					</TD>
				</tr>
		...
		<td align="center">
			Les cotisations se font sur une base annuelle.&nbsp;<br>
			Entrez ci-dessous la date de début de la première session de cotisation :&nbsp;<br><br>
			...
			&nbsp;<B>(format jj/mm/aaaa)</B><br><br><br><br>
			Entrez ci-dessous le nombre de sessions de cotisation à afficher dans le module adhésion:&nbsp;<br><br>
    ...
    <tr>
		<td align="center" colspan="2">
      		<input type="button" name="validate" value="Valider" CLASS="BOUTON_STANDARD" onClick=Valider(config_module)>
