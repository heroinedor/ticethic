...
function showVersion() {
	...
	return "<b class=color>SQuery $version</b>";
}
...
function showCredits($link) {
	...
	return "<a href=\"javascript:void(0);\" onclick=\"return overlib('Coded by <font class=color>Curtis Brown</font><br>Supports: <font class=color>Too many to mention</font><br><br>Based on original code by <font class=colory>David Cramer</font> released to the public domain. Incorporates portions of the gsQuery Library (<a href=\\'http://www.gsquery.org\\' target=_new class=color>www.gsQuery.org</a>)<br><br>Come play on the <font class=color>Malicious Bastards CoD:UO Server</font> (<a href=\\'http://www.squery.com\\' target=_new class=color>70.85.139.243:28960</a>)<br><br>More info about this Tool can be found at (<a href=\\'http://www.squery.com\\' target=_new class=color>www.squery.com</a>)<a href=\\'".$localpath."debug.php\\' target=_new class=color>.</a><br><br>', STICKY, CAPTION, 'SQuery $version', CENTER);\" onmouseout=\"nd();\" class=\"link\">$link</a>";
}
