<?
include_once($_SERVER["DOCUMENT_ROOT"]."/modules/servstat/config.php");
include_once($_SERVER["DOCUMENT_ROOT"]."/modules/servstat/lib.php");
...
$content.='	</TR>'."\n";
$content.='	<TR>'."\n";
$content.='		<TD ALIGN="center"><IMG SRC="'.$path["mappicture"].'/'.$info["nameofthemap"].'.gif" BORDER="1" ALT="'.$info["nameofthemap"].'" HEIGHT="80"></TD>'."\n";
$content.='	</TR>'."\n";
$content.='	<TR>'."\n";
...
if ($topTen !=""){
$content.='	<TR>'."\n";
$content.='		<TD  ALIGN="center"><B><A HREF="javascript:Zoom(\'/modules/servstat/top10.php\',\'top10\')">TOP 10</a></B></TD>'."\n";
}
$content.='	</TR>'."\n";
$content.='</TABLE>'."\n";
?>