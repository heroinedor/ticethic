...
<? } ?>
	...
	if(!count($gameserver->players)) {
    	echo "<tr><td style=\"padding-left: 4px; border: 1px solid $col_border; border-top: none;\" class=\"bluebox\">(none)</td><td style=\"border-bottom: 1px solid $col_border; border-right: 1px solid $col_border;\" class=\"bluebox\">&nbsp;</td><td style=\"border-bottom: 1px solid $col_border; border-right: 1px solid $col_border;\" class=\"bluebox\">&nbsp;</td></tr>";
    	}
	else {
...
echo "</tr>";
		...
		if ($o == 0)
			echo "<tr><td style=\"padding-left: 4px; border: 1px solid $col_border; border-top: none;\" class=\"bluebox\">(none)</td><td style=\"border-bottom: 1px solid $col_border; border-right: 1px solid $col_border;\" class=\"bluebox\">&nbsp;</td><td style=\"border-bottom: 1px solid $col_border; border-right: 1px solid $col_border;\" class=\"bluebox\">&nbsp;</td><td style=\"border-bottom: 1px solid $col_border; border-right: 1px solid $col_border;\" class=\"bluebox\">&nbsp;</td></tr>";
		?>
		</table>
...
echo"</tr>";
		...
		if ($o == 0)
			echo "<tr><td style=\"padding-left: 4px; border: 1px solid $col_border; border-top: none;\" class=\"redbox\">(none)</td><td style=\"border-bottom: 1px solid $col_border; border-right: 1px solid $col_border;\" class=\"redbox\">&nbsp;</td><td style=\"border-bottom: 1px solid $col_border; border-right: 1px solid $col_border;\" class=\"redbox\">&nbsp;</td><td style=\"border-bottom: 1px solid $col_border; border-right: 1px solid $col_border;\" class=\"redbox\">&nbsp;</td></tr>";
		?>
		</table>
		</td></tr>
		</table>
