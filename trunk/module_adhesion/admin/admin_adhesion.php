...
function AfficheOngletNavig(){
  ...
  echo "\n\t\t\t&nbsp;[&nbsp;";
	echo "\n\t\t\t<a href=\"admin.php?op=Extend-Admin-SubModule&ModPath=adhesions&ModStart=admin/admin_adhesion&choix=Configuration\" CLASS=\"HEADA\">Configuration du module</a>";
 	echo "\n\t\t\t&nbsp;]";
	echo "\n\t\t</TD>";
	echo "\n\t\t<TD CLASS=\"TITBOXC\" ALIGN=\"CENTER\">";
  echo "\n\t\t\t&nbsp;[&nbsp;";
	echo "\n\t\t\t<a href=\"admin.php?op=Extend-Admin-SubModule&ModPath=adhesions&ModStart=admin/admin_adhesion&choix=Adherents\" CLASS=\"HEADA\">Consultation/Validation des adhérents</a>";
 	echo "\n\t\t\t&nbsp;]";
	echo "\n\t\t</TD>";
	echo "\n\t\t<TD CLASS=\"TITBOXC\" ALIGN=\"CENTER\">";
  echo "\n\t\t\t&nbsp;[&nbsp;";
	echo "\n\t\t\t<a href=\"admin.php?op=Extend-Admin-SubModule&ModPath=adhesions&ModStart=admin/admin_adhesion&choix=Cotisations\" CLASS=\"HEADA\">Gestion des cotisations</a>";
 	echo "\n\t\t\t&nbsp;]";
	echo "\n\t\t</TD>";
	echo "\n\t</TR>";
	echo "\n</TABLE><BR>";
